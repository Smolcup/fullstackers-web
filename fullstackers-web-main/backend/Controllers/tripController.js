...
// Search trips with more detailed search
exports.searchTrips = async (req, res) => {
  try {
    const { q, destination, minPrice, maxPrice, duration, difficulty } = req.query;
    ...
    if (q) {
      query.$or = [
        ...
        { 'itinerary.title': { $regex: q, $options: 'i' } },
        { 'itinerary.description': { $regex: q, $options: 'i' } }
      ];
    }
